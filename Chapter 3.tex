...
\mintinline{R}|check.method| is a function in \mintinline{R}|Tools.R| which checks if a pricing method is specified and if it is supported by the package.
...
\mintinline{R}|vanilla.bs| is the function for option pricing via Black-Scholes formula, as we see from Equation \ref{eq:BS Formula Call} and \ref{eq:BS Formula Put}.
