...
\mintinline{R}|Tools.R|        & Other supplementary functions used in package, including objects integrity check and plottign functions
\end{tabular}
...
As shown by the codes above, depending on the value of input for the argument \mintinline{R}|option|, 
